...
public class HomeController {
	...
	public AuthResponse authRequest(@Valid @RequestBody AuthRequest auth) throws JsonMappingException, JsonProcessingException {
		
		
//		String xmlValue="";
//		try {
//		xmlValue= mapper.writeValueAsString(auth);
//		}catch(Exception e) {
//			e.printStackTrace();
		auth.getMeta().setUdc(null);
		SignedRequest sr=new SignedRequest();
		sr.setAuthreqdata(auth);
