...
public class AuthTransactionRecord {
	...
	public AuthTransactionRecord() {
	}

	public AuthTransactionRecord(String txn, String tid, String ac, String ver, String pi, String pa, String pfa,
			String bio, String bt, String pin, String otp, String res_code, String udc, String rdsid, String rdsver,
			String dpid, String dc, String mi, String mc, String sa, String rc, String actn, String ret, String err,
			LocalDateTime request_receipt_time, LocalDateTime request_forward_time, LocalDateTime response_receipt_time,
			LocalDateTime response_forward_time, LocalDateTime packet_response_time, String client_ip, char type,
			String lk, String uid_token, String info, String server_ip, String client_lk, String ci, String macid,
			String reference_no) {
		super();
		this.txn = txn;
		this.tid = tid;
